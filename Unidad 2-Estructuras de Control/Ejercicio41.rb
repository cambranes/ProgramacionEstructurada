...
main()#¿Para que funciona?
#QA realizado por Rodrigo Hernández
#Entradas probadas: 0, 1(2), 3(1-4-7)
#El algoritmo funciona, pero te pide una variable innecesaria despues de los resultados
