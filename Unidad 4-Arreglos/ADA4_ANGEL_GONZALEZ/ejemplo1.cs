    ...
    */
    class program
    {
        ...
        static void asginaciondeMatriz(int[,] matr)
        {
            ...
            recorrerMatriz1_2Ascendente(matr);
        ...
        static void recorrerMatriz1_2Ascendente(int[,] rango)
        {
            ...
            {
                //ciclo for que lee las columnas de la matri
                //al restarle la cantidad de filas leidas a N se genera el arreglo deseado para la matriz
