    ...
    */
    class program
    {
        ...
        static void asginaciondeMatriz(int[,] matr)
        {
            ...
            recorrerMatriz3Descendente(matr);
        }
        ///<remarks>
        ///la funcion leera el area 3 de manera descendente y generara una matriz impresa
        ///</remarks>
        static void recorrerMatriz3Descendente(int[,] rango)
        {
