    ...
    */
    class program
    {
        ...
        static void asginaciondeMatriz(int[,] matr)
        {
            ...
            recorrerMatriz4Descendente(matr);
        }
        ///<remarks>
        ///la funcion leera el area 4 de manera descendente y generara una matriz impresa
        ///</remarks>
        static void recorrerMatriz4Descendente(int[,] rango)
        {
            //se define una constante N en base a la longitud de uno de los parametros de la matriz
            int N=rango.GetLength(1);
            for(int fil=N-1; fil>1; fil--)
            {
            ...
            for(int fil=1; fil>0; fil--)
            {
                for(int col=1; col<fil+1; col++)
                {
                    //se imprime la posicion de la matriz mediante Write en un string
                    Console.Write("   " + rango[fil,col]);
                }
