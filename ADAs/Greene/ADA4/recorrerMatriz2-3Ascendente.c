 ...
 * @brief Programa que recorre la zona 2 a 3 forma ascendente de una matriz de NxN
 * @version 0.1
 * @date 2020-03-22
 * 
...
/**
 * @brief Función que imprime la zona 2 a 3 de forma ascendente de la matriz
 * 
 * @param arr 
 */
void recorrerMatriz2_3Ascendente(int arr[][N])
