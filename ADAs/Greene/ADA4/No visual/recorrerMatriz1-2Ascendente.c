 ...
 * @brief Programa que recorre la zona 1 a 2 forma ascendente y no visual de una matriz de NxN
 * @version 0.1
 * @date 2020-03-22
 * 
...
/**
 * @brief Función que imprime la zona 1 a 2 de forma ascendente y no visual de la matriz
 * 
 * @param arr 
 */
void recorrerMatriz1_2Ascendente(int arr[][N])
