 ...
 * @brief Programa que recorre la zona 2 a 3 forma descendente y no visual de una matriz de NxN
 * @version 0.1
 * @date 2020-03-22
 * 
...
/**
 * @brief Función que imprime la zona 2 a 3 de forma descendente y no visual de la matriz
 * 
 * @param arr 
 */
void recorrerMatriz2_3Descendente(int arr[][N])
