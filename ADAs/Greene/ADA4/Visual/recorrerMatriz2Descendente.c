 ...
 * @brief Programa que recorre la zona 2 de forma descendente y visual de una matriz de NxN
 * @version 0.1
 * @date 2020-03-22
 * 
...
/**
 * @brief Función que imprime la zona 2 de forma descendente y visual de la matriz
 * 
 * @param arr 
 */
void recorrerMatriz2Descendente(int arr[][N])
