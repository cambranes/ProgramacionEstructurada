 ...
 * @brief Programa que recorre la zona 3 a 4 de forma descendente de una matriz de NxN
 * @version 0.1
 * @date 2020-03-22
 * 
...
/**
 * @brief Función que imprime la zona 3 a 4 de forma descendente de la matriz
 * 
 * @param arr 
 */
void recorrerMatriz3_4Descendente(int arr[][N])
