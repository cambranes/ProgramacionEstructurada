...
void main()
{
 ...
 Entrada(ref elevacion);
 Proceso(elevacion, ref respuestaFinal);
 Salida(ref respuestaFinal);
}
...
*/
void Proceso(int x, ref float res)
{
